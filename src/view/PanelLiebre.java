...
/**
 * The type Panel liebre.
 */
public class PanelLiebre extends JPanel {
    ...
    public void iniciarComponentes() {
        ...
        lblTitulo = new JLabel("Problema liebre");
        ...
        btnVolver.setActionCommand("VOLVERLIEBREPIROBA");
        add(btnVolver);


        btnGenerarTxt = new JButton("Liebre piroba");
        btnGenerarTxt.setBounds(70, 200, 500, 50);
        btnGenerarTxt.setActionCommand("LIEBREPIROBA");
        add(btnGenerarTxt);
